"""run.py — train both arms (baseline RoPE vs learned PE) and collect val-loss curves.

    python projects/rope_ablation/run.py     # trains both arms
    python projects/rope_ablation/plot.py    # -> rope_ablation.png
"""
